...
fs.appendFileSync(file, newRecord5, (err) => {
  if (err) throw err;
  console.log('Data addition complete');
});

const newRecord6 = 'Pride and Prejudice, Jane Austen, 1813\n';
fs.appendFileSync(file, newRecord6, (err) => {
  if (err) throw err;
  console.log('Data addition complete');
});
